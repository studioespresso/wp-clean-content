...
if ( ! function_exists( 'clean_content_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see clean_content_custom_header_setup().
 */
function clean_content_header_style() {
...
endif; // clean_content_header_style

if ( ! function_exists( 'clean_content_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see clean_content_custom_header_setup().
 */
function clean_content_admin_header_style() {
?>
	<style type="text/css">
...
endif; // clean_content_admin_header_style
